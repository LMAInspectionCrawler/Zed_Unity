...
public class ZEDMixedRealityPlugin : MonoBehaviour
{
	...
	public void LoadHmdToZEDCalibration()
	{
		if (hasVRDevice) {
			...
			hmdtozedCalibration.translation.x = 0.038759f;//-zedCamera.Baseline/2;
			hmdtozedCalibration.translation.y = -0.002843f;// 0.0f;
			hmdtozedCalibration.translation.z = 0.117377f;
